...
@implementation XLTVideoListLayout
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CGFloat cellW = [self.delegate waterFallLayout:self withForItemAtIndexPath:indexPath.item];
