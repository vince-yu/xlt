...
#import "XLTHomeKingKongPageControl.h"


@interface XLTHomeKingKongPageControl ()


@end

@implementation XLTHomeKingKongPageControl
...
-(void)createPointView{
    ...
    for (int page=0; page<_numberOfPages; page++) {
        if(page==_currentPage){
             UIView *currPointView=[[UIView alloc]initWithFrame:CGRectMake(startX, startY, _controlSize, 2)];
//             currPointView.layer.cornerRadius=_controlSize/2;
            ...
            UIView *otherPointView=[[UIView alloc]initWithFrame:CGRectMake(startX, startY, _controlSize, 2)];
...
//    CGRect newTemp=newSeltect.frame;
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        newSeltect.frame=CGRectMake(mx, newTemp.origin.y, self->_controlSize, self->_controlSize);
