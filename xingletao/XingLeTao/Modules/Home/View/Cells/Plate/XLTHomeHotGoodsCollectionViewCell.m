...
@interface XLTHomeHotGoodsCollectionViewCell ()
...
@end
@implementation XLTHomeHotGoodsCollectionViewCell
...
- (void)letaoUpdateCellDataWithInfo:(id _Nullable )itemInfo {
    ...
    if (![paidNumber isKindOfClass:[NSNumber class]]
        ...
        self.salesAmountLabel.text = [NSString stringWithFormat:@"爆卖%@件",@"0"];
    } else {
        self.salesAmountLabel.text = [NSString stringWithFormat:@"爆卖%@件",[paidNumber letaoTenThousandNumberFormat]];
    }
