//
//  XLTHomeSingleGoodsCollectionViewCell.m
//  XingLeTao
//
...
@interface XLTHomeSingleGoodsCollectionViewCell ()
...
@end
@implementation XLTHomeSingleGoodsCollectionViewCell
...
- (void)letaoUpdateCellDataWithInfo:(id _Nullable )itemInfo {
    ...
    if ([itemInfo isKindOfClass:[NSDictionary class]]) {
        ...
        itemSource = itemInfo[@"item_source"];
    ...
    self.letaoPaidCountLabel.hidden = [itemSource isEqualToString:XLTSuNingPlatformIndicate];
