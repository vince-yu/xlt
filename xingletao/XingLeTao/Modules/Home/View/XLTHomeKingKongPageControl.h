...
@class XLTHomeKingKongPageControl;
@protocol EllipsePageControlDelegate <NSObject>

-(void)ellipsePageControlClick:(XLTHomeKingKongPageControl*)pageControl index:(NSInteger)clickIndex;

@end
@interface XLTHomeKingKongPageControl : UIControl
