...
@implementation XLTBasePickView
...
//    [self setFrame:CGRectMake(0, kScreenHeight, self.width, self.height)];
...
- (UILabel *)titleLabel{
    if (!_titleLabel) {
        ...
        _titleLabel.center = CGPointMake(kScreenWidth / 2.0, 22);
        _titleLabel.font = [UIFont fontWithName:kSDPFMediumFont size:16];
