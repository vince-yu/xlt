//
//  XLTUserOldPhoneVerificationVC.m
//  XingLeTao
//
...
@interface XLTUserOldPhoneVerificationVC ()
...
@implementation XLTUserOldPhoneVerificationVC
...
- (IBAction)submitBtnClicked:(id)sender {
    XLT_WeakSelf;
    [XLTUserInfoLogic xingletaonetwork_requestoldPhoneVerifyCodeWith:self.phoneNumber code:self.verificationCodeTextField.text success:^(id balance) {
        XLT_StrongSelf;
        [self pushBindVC];
...
- (IBAction)xingletaonetwork_requestVerificationCodeBtnClicked:(id)sender {
    XLT_WeakSelf;
    [XLTUserInfoLogic xingletaonetwork_requestoldPhoneSendCodeWith:self.phoneNumber success:^(XLTBaseModel *model) {
        XLT_StrongSelf;
        BOOL shoulPush = NO;
