...
@property (nonatomic, assign) CGSize signImagesSize;
@property (nonatomic, assign) CGFloat signImageViewX;
@end
...
- (void)layoutSubviews {
    ...
    CGFloat signImageViewX = self.signImageViewX;
    CGFloat signImageViewY = 0;
    if (_signImagesSize.width > 0 && _signImagesSize.height > 0) {
        self.signImageView.frame = CGRectMake(signImageViewX, signImageViewY, _signImagesSize.width, _signImagesSize.height);
        self.signImageView.layer.masksToBounds = YES;
        self.signImageView.layer.cornerRadius = ceilf(_signImagesSize.height/2);
    ...
    CGFloat labelX = 0;
    if (self.signImageView.image == nil && !(_signImagesSize.width > 0 && _signImagesSize.height > 0)) {
        labelX = 0;
    } else {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    if (self.advertScrollViewStyle == SGAdvertScrollViewStyleMore) {
        ...
        cell.signImagesSize = self.signImagesSize;
        cell.signImageViewX = self.signImageViewX;
