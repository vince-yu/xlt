...
- (void)initElements {
    ...
    if (self.enableScroll) {
        ...
        self.animationLabel.frame = CGRectMake(5, self.bounds.size.height / 2 - self.animationLabel.frame.size.height / 2, self.animationLabel.frame.size.width, self.animationLabel.frame.size.height);
