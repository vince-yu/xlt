...
- (void)userDidFinishDrag {
    ...
    [self updateCacheProgressViewIfNeed];
    [self.playerView jp_seekToTime:CMTimeMakeWithSeconds([self xingletaonetwork_requestElapsedTimeInterval], 1000)];
}
...
- (void)displayCacheProgressViewIfNeed {
    ...
    NSUInteger dragStartLocation = [self xingletaonetwork_requestDragStartLocation];
...
- (NSUInteger)xingletaonetwork_requestDragStartLocation {
    return self.fileLength * self.dragSlider.value;
}

- (NSTimeInterval)xingletaonetwork_requestElapsedTimeInterval {
...
- (void)callLayoutMethodForContainerSubviews {
 ...
 nearestViewControllerInViewTree:nearestViewController
            interfaceOrientation:[self xingletaonetwork_requestCurrentInterfaceOrientation]];
        }
    }
...
- (JPVideoPlayViewInterfaceOrientation)xingletaonetwork_requestCurrentInterfaceOrientation {
