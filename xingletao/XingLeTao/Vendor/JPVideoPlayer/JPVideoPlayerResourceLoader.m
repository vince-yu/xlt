...
- (void)findAndStartNextLoadingRequestIfNeed {
    ...
    NSRange dataRange = [self xingletaonetwork_requestRequestRangeWithRequest:self.runningLoadingRequest];
...
- (NSRange)xingletaonetwork_requestRequestRangeWithRequest:(AVAssetResourceLoadingRequest *)loadingRequest {
