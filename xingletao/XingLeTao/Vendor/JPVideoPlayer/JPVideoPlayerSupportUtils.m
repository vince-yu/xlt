...
- (void)handleCellUnreachableTypeForCell:(UIView<JPVideoPlayerCellProtocol> *)cell
    ...
    NSUInteger unreachableCellCount = [self xingletaonetwork_requestUnreachableCellCountWithVisibleCellsCount:visibleCells.count];
...
- (NSUInteger)xingletaonetwork_requestUnreachableCellCountWithVisibleCellsCount:(NSUInteger)visibleCellsCount {
