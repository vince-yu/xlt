 ...
 *                               it be use to xingletaonetwork_request `safeAreaInsets` to help layout subviews.
...
/**
 * This method will be called when the downloader xingletaonetwork_requested the file length or read from disk.
 *
