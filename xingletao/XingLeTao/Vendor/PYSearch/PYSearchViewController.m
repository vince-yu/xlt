...
- (UILabel *)searchHistoryHeader
{
    if (!_searchHistoryHeader) {
        ...
        if (_isXLTCustomStyle) {
            titleLabel.textColor = [UIColor colorWithHex:0xFF25282D];
            titleLabel.font= [UIFont letaoRegularFontWithSize:16];
            [titleLabel sizeToFit];
        }
    }
...
- (void)setSearchHistoryStyle:(PYSearchHistoryStyle)searchHistoryStyle
{
    ...
    switch (searchHistoryStyle) {
        ...
        case PYSearchHistoryStyleBorderTag:
            for (UILabel *tag in self.searchHistoryTags) {
                tag.backgroundColor = self.isXLTCustomStyle ? [UIColor whiteColor] : [UIColor clearColor];
                ...
                if (self.isXLTCustomStyle) {
                    ...
                    tag.textColor = [UIColor colorWithHex:0xFF25282D];
                }
            }
            break;
