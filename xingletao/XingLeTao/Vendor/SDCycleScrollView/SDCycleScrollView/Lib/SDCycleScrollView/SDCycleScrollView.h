...
@interface XLTGoodDetailSDCycleScrollView : SDCycleScrollView

@end



@protocol XLTHomePageCycleScrollViewDelegate <NSObject>
...
@interface XLTHomePageCycleScrollView : SDCycleScrollView
@property (nonatomic, weak) id <XLTHomePageCycleScrollViewDelegate> mainScrollViewDelegate;
@end
